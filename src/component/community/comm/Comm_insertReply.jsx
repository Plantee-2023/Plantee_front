...
const Comm_insertReply = () => {
  ...
  const onClickSave = async () => {
    if (form.contents === "") {
      ...
      if (window.confirm("저장하시겠습니까?")) {
        const data = {
          ...form, contents: form.contents, post_id: post_id
        };
        //console.log(data);
        await axios.post("/comm/update", data);
        alert("저장을 완료했습니다.");
                ...
                {!isChecked ?
                  <>
                    ...
                    <CKEditor config={{ ckfinder: { uploadUrl: '/comm/ckupload' } }}
                      ...
                      data={form.uid !== sessionStorage.getItem("uid") ? "" : form.contents}
...
export default Comm_insertReply;